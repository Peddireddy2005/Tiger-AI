...
const FEATURES = [
  { icon: "🚀", title: "Multiple AI Models", desc: "DeepSeek, Gemini, Claude, GPT-4o" },
  { icon: "🔮", title: "5 Specialized Modes", desc: "Coding, Research, Learning & more" },
  { icon: "💾", title: "Full History", desc: "All conversations saved & searchable" },
    ...
    <div className="auth-page">
      <div className="auth-left">
        ...
        <div className="auth-left-bottom">
          <div className="auth-trust"><span className="auth-trust-stars">★★★★★</span><span>Premium AI experience, free to get started</span></div>
        </div>
      </div>
        ...
        <div className="auth-card">
          ...
          <form onSubmit={handleSubmit} className="auth-form-inner">
            ...
            <div className="form-group">
              ...
              <div className="pw-wrap">
                <input type={showConfirm ? "text" : "password"} placeholder="Repeat password" value={confirm} onChange={(e) => setConfirm(e.target.value)} required />
                <button type="button" className="pw-toggle" onClick={() => setShowConfirm((p) => !p)}>{showConfirm ? "Hide" : "Show"}</button>
              </div>
              {confirm && password !== confirm && <span className="field-hint error">Passwords don't match</span>}
              {confirm && password === confirm && <span className="field-hint ok">✓ Passwords match</span>}
            </div>
            <button type="submit" className="auth-submit-btn" disabled={loading || (confirm && password !== confirm)}>
