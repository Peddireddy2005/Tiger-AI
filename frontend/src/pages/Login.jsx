...
const FEATURES = [
  ...
  { icon: "💻", title: "Coding Assistant", desc: "Debug, write & explain code" },
    ...
    <div className="auth-page">
      ...
      <div className="auth-left">
        ...
        <div className="auth-left-center">
          <h1 className="auth-left-headline">Your AI.<br /><span className="grad">Supercharged.</span></h1>
          <p className="auth-left-sub">One intelligent workspace for coding, research, learning and productivity — powered by the world's best AI models.</p>
          ...
          <div className="auth-preview">
            <div className="auth-preview-label">Live preview</div>
        ...
        <div className="auth-left-bottom">
          <div className="auth-trust"><span className="auth-trust-stars">★★★★★</span><span>Trusted by developers, students and professionals</span></div>
        </div>
      </div>
      ...
      <div className="auth-right">
        <div className="auth-card">
          ...
          {(error || params.get("error")) && (
            <div className="auth-error">{error || "Google sign-in failed."}</div>
          )}
          {params.get("verified") && (
